...
<<<<<<< HEAD
        ...
        actionsCol.setCellFactory(col -> new TableCell<>() {
            ...
            private final HBox buttons = new HBox(5, likeBtn, editBtn, deleteBtn);
            {
...
<<<<<<< HEAD
            ...
            rs2.next();
            int totalVues = rs2.getInt("totalVues");
...
<<<<<<< HEAD
    ...
    public static class Publication {
        private final int id, nombreVues, nombreLikes;
        private final String titre, description, dateCreation, categorie;
        public Publication(int id, String titre, String description, String dateCreation, String categorie, int nombreVues, int nombreLikes) {
